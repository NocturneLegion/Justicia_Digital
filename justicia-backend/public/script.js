...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const setupJudicialAuth = () => {
        ...
        if (token && currentUser) {
            // Ya hay sesión activa, NO mostrar nada (completamente silencioso)
            // console.log('🔍 [SCRIPT.JS] Sesión activa detectada, permaneciendo silencioso');
            return; // No hacer nada, quedarse silencioso
        } else {
    ...
    // ✅ Mostrar éxito del login (solo para login nuevo)
    ...
    // Función para cerrar sesión manualmente (disponible globalmente)
    window.manualLogout = () => {
