// 🔒 GESTOR DE NAVBAR - ACTUALIZAR BOTÓN DE SESIÓN CON ESTILO PÚRPURA
(function() {
    'use strict';
    ...
    const updateSessionButton = () => {
        ...
        if (token && currentUser) {
            // Hay sesión activa - cambiar a "Cerrar sesión" con estilo púrpura
            try {
                const user = JSON.parse(currentUser);
                loginBtn.textContent = 'Cerrar sesión';
                loginBtn.className = 'btn btn-logout-purple';
